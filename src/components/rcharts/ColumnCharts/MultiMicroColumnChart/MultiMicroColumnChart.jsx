...
import useStyles from './MultiMicroColumnChart.styles';
...
export default function MultiMicroColumnChart({
  data,
  xAxisLabelKey,
  yAxisLabel,
  valueKey,
...
MultiMicroColumnChart.defaultProps = {
  data: null,
  xAxisLabelKey: null,
  yAxisLabel: null,
  valueKey: null,
...
MultiMicroColumnChart.propTypes = {
